...
function isSvn ($path)
{
	return file_exists ($path . DIRECTORY_SEPARATOR .'.svn') && is_dir ($path . DIRECTORY_SEPARATOR .'.svn');
}

function isGit ($path)
{
	return file_exists ($path . DIRECTORY_SEPARATOR .'.git') && is_dir ($path . DIRECTORY_SEPARATOR .'.git');
}
