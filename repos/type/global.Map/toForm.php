...
<input type="hidden" id="<?= $fieldId ?>_LATITUDE_" name="<?= $fieldName ?>[]" value="<?= $field->getLatitude () ?>" />
<input type="hidden" id="<?= $fieldId ?>_LONGITUDE_" name="<?= $fieldName ?>[]" value="<?= $field->getLongitude () ?>" />
