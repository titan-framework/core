...
CKEDITOR.plugins.addExternal (
	'iframedialog',
	'<?= Instance::singleton ()->getUrl () ?>titan.php?target=tResource&type=Fck&file=iframedialog/',
	'plugin.js'
);

CKEDITOR.plugins.addExternal (
	'mediaembed',
	'<?= Instance::singleton ()->getUrl () ?>titan.php?target=tResource&type=Fck&file=mediaembed/',
	'plugin.js'
);
