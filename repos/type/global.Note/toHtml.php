...
<div id="idList" style="margin: 0px;">
	<table style="background-color: #FFF;">
		<tr>
			...
			<td class="cTableHeader" width="10%"></td>
		</tr>
			...
			else
			{
				...
				<tr class="cTableItem">
					...
					<td class="icon" nowrap="nowrap">
						<img src="titan.php?target=loadFile&file=interface/icon/gallery.gif" border="0" title="<?= __ ('View Medias') ?>" alt="<?= __ ('View Medias') ?>" onclick="JavaScript: global.Note.view ('<?= $obj->_id ?>', this);" />&nbsp;
						<img src="titan.php?target=tResource&type=Note&file=earth.png" class="icon" border="0" title="<?= __ ('Tracking') ?>" alt="<?= __ ('Tracking') ?>" onclick="JavaScript: global.Note.earth ('<?= $obj->_id ?>', this);" />&nbsp;
						<img src="titan.php?target=loadFile&file=interface/icon/delete.gif" class="icon" border="0" title="<?= __ ('Delete') ?>" alt="<?= __ ('Delete') ?>" onclick="JavaScript: global.Note.delete ('<?= $obj->_id ?>', this);" />&nbsp;
					</td>
				</tr>
				<tr class="cSeparator"><td colspan="5"></td></tr>
				<?
