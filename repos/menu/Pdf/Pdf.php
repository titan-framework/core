<?
class MenuPdf extends MenuItem
{
	private $action = NULL;
	...
	{
		return '<li class="cItemLong" onclick="JavaScript: openPrintPopup (\'titan.php?target=pdf&amp;toSection='. $this->section->getName () .'&amp;toAction='. $this->action->getName () .'&itemId='. $this->itemId .'\');"><img align="left" src="'. self::imageUrl ($this->image) .'" title="'. $this->label .'" alt="'. $this->label .'" />'. $this->label .'</li>';
	}
	
	public function getSubmenuItem ()
	{
		return '<li class="cSubItem" onclick="JavaScript: openPrintPopup (\'titan.php?target=pdf&amp;toSection='. $this->section->getName () .'&amp;toAction='. $this->action->getName () .'&itemId='. $this->itemId .'\');"><div>'. $this->label .'</div></li>';
	}
}
?>