...
class FCKeditor
{
	 ...
	 */
	public function __construct( $instanceName, $TitanName )
 	{
	...
	public function CreateHtml()
	{
		...
		if ( $this->IsCompatible() )
		{
			...
			$Link .= '&amp;instUrl='. Instance::singleton ()->getUrl ();

			// Render the linked hidden field.
			$Html .= "<input type=\"hidden\" id=\"{$this->TitanName}\" name=\"{$this->InstanceName}\" value=\"{$HtmlValue}\" style=\"display:none\" />" ;
