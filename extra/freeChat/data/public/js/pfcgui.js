...
//    this.builder = new pfcGuiBuilder();
  ...
  */
  ...
  notifyWindow: function()
  {
	...
	document.getElementById ('idChatNotify').innerHTML = this.windownotifynb + ' mensagens novas!';
  ...
  unnotifyWindow: function()
  {
	...
	document.getElementById ('idChatNotify').innerHTML = '';
  ...
  buildChat: function()
  {
    ...
    var img = document.createElement('img');
    img.setAttribute('src', 'titan.php?target=loadFile&amp;file=interface/image/logo_80x15.gif');
