...
<div style="width:250px;background-color:#FFF;border:1px solid #000;padding:10px;position:relative;margin:auto">
  <p style="padding:0;margin:0;text-align:center;">
    <img src="titan.php?target=loadFile&amp;file=interface/image/indicatormediumgb6.gif"
         alt=""
...
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/xajax.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/compat.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/md5.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/cookie.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/image_preloader.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/myprototype.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/regex.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/utf8.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/sprintf2.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/activity.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/mousepos.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/createstylerule.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/pfcclient.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/pfcgui.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/pfcresource.js"></script>
<script type="text/javascript" src="titan.php?target=loadFile&amp;file=extra/freeChat/data/public/js/pfcprompt.js"></script>
...
<a href="http://www.phpfreechat.net" style="text-align:center"><img src="titan.php?target=loadFile&amp;file=interface/image/logo_80x15.gif" alt="PHP FREE CHAT [powered by phpFreeChat-<?php echo $version ?>]" /></a>
</div> <!-- pfc_notloading -->
