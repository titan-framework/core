  <img style="display: none;" id="pfc_minmax" onclick="pfc.swap_minimize_maximize()" src="<?php echo $c->getFileUrlFromTheme('images/'.($start_minimized?'maximize':'minimize').'.gif'); ?>" alt=""/>
  <h2 style="display: none;" id="pfc_title"><?php echo $title; ?></h2>
...
<?php if ($display_pfc_logo) { ?>
      <a href="http://www.phpfreechat.net"
        ...
        <img src="titan.php?target=loadFile&amp;file=interface/image/logo_80x15.gif"
