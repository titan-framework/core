...
class pfcGlobalConfig
{
  ...
  function init()
  {
    ...
    $this->theme_default_path = Instance::singleton ()->getCorePath () .'extra/freeChat/themes';
  ...
  */
  ...
  {
	return 'titan.php?target=loadFile&file=extra/freeChat/themes/'.$this->theme.'/'.$file;
