...
/* 
 * Titan Framework Modfication
 * By Camilo Carromeu
 * To convert from UTF-8
 */
class TitanFPDF extends FPDF
{
	...
	function Text ($x, $y, $txt, $isUTF8 = TRUE)
	{
		if ($isUTF8)
		{
	...
	function Cell ($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $isUTF8 = TRUE)
	{
		if ($isUTF8)
		{
			if (function_exists ('iconv'))
	...
	function Write ($h, $txt, $link='', $isUTF8 = TRUE)
	{
		if ($isUTF8)
		{
			if (function_exists ('iconv'))
...
function _parsegif($file)
{
	...
	else
	{
		// Use temporary file
		// $tmp = tempnam('.','gif');
		/* Titan Framework Modfication - By Camilo Carromeu */
		$tmp = tempnam (Instance::singleton ()->getCachePath (), 'gif');
		if(!$tmp)
