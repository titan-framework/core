...
class Securimage {
   ...
   * @var string
   */
  var $charset = 'ABCDEFGHKLMNOPQRSTUVXWYZ';
  ...
  function Securimage()
  {
	  ...
	  $this->wordlist_file = Instance::singleton ()->getCorePath () .'extra/captcha/wordlist';
	  
    if ( session_id() == '' ) { // no session has been started yet, which is needed for validation
      session_name (Instance::singleton ()->getSession () .'_PUBLIC_');
	  session_start ();
    }
  }
