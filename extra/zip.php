...
// +----------------------------------------------------------------------+
//
// $Id: Zip.php,v 1.6 2004/02/26 15:33:36 vblavet Exp $
  ...
  define( 'ARCHIVE_ZIP_TEMPORARY_DIR', Instance::singleton ()->getCachePath () );
  ...
  function _deleteByRule(&$p_result_list, &$p_params)
  {
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++) {
      ...
      // ----- Look for extract by ereg rule
               ...
               && ($p_params[ARCHIVE_ZIP_PARAM_BY_EREG] != "")) {
          // Titan migration for 5.3 (Camilo Carromeu)
